            ...
            <nav className="flex justify-between items-center px-6 lg:px-20 py-3 fixed top-0 w-full bg-white z-50 shadow-sm">
                ...
                <div className="flex gap-6 items-center">
                    {!isAuthenticated ? (
                        ...
                        <>
                            <button onClick={() => navigate("/home")} className="bg-black text-white px-6 py-2.5 rounded-lg text-sm font-black uppercase tracking-widest hover:bg-gray-800 transition-all shadow-lg shadow-black/10">Go to Home</button>
